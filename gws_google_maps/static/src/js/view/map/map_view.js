odoo.define('gws_google_maps.MapView', function (require) {
    'use strict';

    var BasicView = require('web.BasicView');
    var core = require('web.core');

    var MapModel = require('gws_google_maps.MapModel');
    var MapRenderer = require('gws_google_maps.MapRenderer');
    var MapController = require('gws_google_maps.MapController');
